...
export const PageMenu = () => {
  ...
  return (
    <Fragment>
      <Menu className={styles.appMenu} fixed="top" inverted>
      ...
      <Menu className={styles.mobileMenu} fixed="top" inverted>
        <Menu.Item header as={Link} to={{ type: AvailableRoutes.HOME }}>SimplyBudget</Menu.Item>
        {isLoggedIn ? (
      ...
      {isLoggedIn && expanded && (
        <Menu fixed="top" inverted vertical fluid className={cx(styles.secondaryMenu, styles.mobileMenu)}>
          <Menu.Item
            as={NavLink}
            to={{ type: budgetRoute, payload: { year, month, budget } }}
            activeClassName="active"
