...
const budgetEntries: BudgetEntry[] = [
  {
    ...
    'id': 414,
    'category': { 'id': 15, 'type': 'expense', 'parent': { 'id': 7 } as Category },
    'month': 1,
    'plan': 100,
    'real': 98,
    ...
    'id': 415,
    'category': { 'id': 16, 'type': 'expense', 'parent': { 'id': 7 } as Category },
    'month': 1,
    'plan': 100,
    'real': 98,
    ...
    'id': 416,
    'category': { 'id': 17, 'type': 'expense', 'parent': { 'id': 7 } as Category },
    'month': 1,
    'plan': 100,
    'real': 98,
    ...
    'id': 419,
    'category': { 'id': 20, 'type': 'expense', 'parent': { 'id': 8 } as Category },
    'month': 1,
    'plan': 100,
    'real': 98,
    ...
    'id': 420,
    'category': { 'id': 21, 'type': 'expense', 'parent': { 'id': 8 } as Category },
    'month': 1,
    'plan': 100,
    'real': 98,
    ...
    'id': 425,
    'category': { 'id': 25, 'type': 'expense', 'parent': { 'id': 9 } as Category },
    'month': 1,
    'plan': 100,
    'real': 98,
    ...
    'id': 426,
    'category': { 'id': 24, 'type': 'expense', 'parent': { 'id': 9 } as Category },
    'month': 1,
    'plan': 100,
    'real': 98,
    ...
    'id': 599,
    'category': { 'id': 22, 'type': 'expense', 'parent': { 'id': 8 } as Category },
    'month': 1,
    'plan': 100,
    'real': 98,
    // 'plan': '',
...
// TODO: Restore state value and route reset to []
const entriesReducer: Reducer<BudgetState['entries'], AppAction> = (state = budgetEntries, action) => {
  switch (action.type) {
...
const loadingReducer: Reducer<BudgetState['loading'], AppAction> = (state = false, action) => {
  switch (action.type) {
    case AvailableRoutes.BUDGET_MONTH_ENTRIES:
      return false
    case getType(Actions.updateEntries):
